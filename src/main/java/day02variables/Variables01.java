...
public class Variables01 {
    ...
    public static void main(String[] args) {
        ...
        When you create a float object, you have to use "f" or "F" at the end of the value. (In real life generally we use double for decimal values.
        We do not prefer float so much.)
