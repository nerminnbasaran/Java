...
public class Queue01 {
    ...
    /*
        1)Queues are First In First Out(FIFO) rule
    ...
    public static void main(String[] args) {
        ...
        que.add("Brad");
        que.add("Jim");
        System.out.println("que = " + que);//[Tom, Ajda, Brad, Jim] => Elements are in insertion order because I used here LinkedList as constructor.
        ...
        System.out.println("intQue = " + intQue);//[5, 15, 91, 9]
        ...
        System.out.println("dq = " + dq);//[Tom, Ajda, Brad, Jim, Aaron, Cindy]=>Elements are in an order according the Java logic because I used LinkedList as constructor.
