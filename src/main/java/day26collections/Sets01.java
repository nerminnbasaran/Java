...
public class Sets01 {
    ...
    /*
        ...
        There are 3 sets i)HashSet: Uses hashing technique.
                         ...
                         iii)TreeSet: TreeSet puts elements in natural order.
                                      While putting elements in natural order it will take too much time.
    ...
    public static void main(String[] args) {
        ...
        System.out.println(hs);//[32, null, 1, 3, 19, 5, 12, 45, 14] --it is in random order ==> HashSet does not put the elements in any order
        ...
        System.out.println("lhs = " + lhs);//lhs = [12, 3, 14, 5, 32, 1, 45, 19, null] ==>LinkedHashSet puts the elements in "insertion order"

        LinkedHashSet<Integer> mLhs = new LinkedHashSet<>();
        mLhs.add(12);
        mLhs.add(31);
        mLhs.add(14);
        mLhs.add(51);
        mLhs.add(32);
        System.out.println("mLhs = " + mLhs);//[12, 31, 14, 51, 32]

        boolean r1 = lhs.retainAll(mLhs);
        //retainAll() method gives the elements from first collection which is common with the second collection.
        //It removes different elements frm the first collection.
        //It does not touch second(inside the parenthesis) collection's elements.

        System.out.println("lhs = " + lhs);//[12, 14, 32]
        System.out.println("r1 = " + r1);//true
        System.out.println("mLhs = " + mLhs);//[12, 31, 14, 51, 32]
        System.out.println("mLhs.size() = " + mLhs.size());//5
        ...
        ts.add(-13);
        ts.add(-50);
        System.out.println("ts = " + ts);//ts = [-50, -13, 2, 5, 13, 19, 24] ==> TreeSet puts elements in natural order.
       ...
       // Example: Store the following addresses in alphabetical order
       ...
       ts1.add("chi@gmail.com");
        ...
        System.out.println("ts1 = " + ts1);//[abc@gmail.com, acd@gmail.com, bcm@gmail.com, caf@gmail.com, chi@gmail.com]
        ...
        System.out.println("ts2 = " + ts2);//[abc@gmail.com, acd@gmail.com, bcm@gmail.com, caf@gmail.com, chi@gmail.com]
        Long time3 = System.nanoTime();

        System.out.println("1.Way->Adding TreeSet: " + (time2-time1));
        System.out.println("2.Way->Adding HashSet convert TreeSet: "+(time3-time2));
