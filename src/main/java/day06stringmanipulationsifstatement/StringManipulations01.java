...
public class StringManipulations01 {
    ...
    //Example 3 : Typ code to find the index of last occurrence of 'm' in a given String.
    // miami ==> 3
    String u = "miami";

    //lastIndexOf('m') will give you the index of the last occurrence of 'a'
    ...
    //Note :If a character is unique in a String indexOf() and lastIndexOf() gives the same output
