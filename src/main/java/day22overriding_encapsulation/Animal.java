...
public class Animal {
    ...
    5)Return Type of the Overridden Methods can be the top return type of the Overriding Method
    ...
    3)"final" keyword can be used for methods
      ...
      The body of "final method" cannot be updated, so it cannot be overridden because in overriding we update the method body
   ...
   What is the difference between "Method Overloading" and "Method Overriding"?
      ...
      iv)We cannot override "static" methods but we can "overload" then
