package day18varargsstirngbuilderstringbuffer;
...
public class StringBuilder01 {
    ...
    /*
        ...
        "thread-safe" means being able to do "multiple threats(task)" at the same time
        ...
        ii)StringBuilder Class: If you need "mutable String" and do not need "multi thread and "synchronization" use StringBuilderClass
        iii)StringBuffer:If you need "mutable String" and need "multi thread and "synchronization" use StringBuffer.
    ...
    public static void main(String[] args) {
        ...
        //insert(4," is love"); will skip first 4 characters, than insert " is love"
        ...
        //If sb2 before sb3 the result will be negative, if sb2 is after sb3 the result will be positive
        //The int value method return displays the difference between the ASCII values
