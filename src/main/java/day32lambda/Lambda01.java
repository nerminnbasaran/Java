...
public class Lambda01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        printSquareOfLengthDistinctlyInReverseOrder(names);
        System.out.println();
        System.out.println(checkLengthToBeLessThanTwelve(names));
        System.out.println();
        System.out.println(checkInitialIsNotToBeX(names));
        System.out.println();
    ...
    public static void printSortedUpperUnique(List<String> names){
        names.stream().distinct().sorted().map(t-> t.toUpperCase()).forEach(t-> System.out.print(t + " "));//ALEX ALEXANDER JİM MARY MİCHAEL TOM
    ...
    public static void printSortedByLengthThenFirstChar(List<String> names){
        names.
                stream().
                sorted(Comparator.comparing(String::length).
                thenComparing(t->t.charAt(0))).//If a method needs parameter
    ...
    public static boolean checkLengthToBeLessThanTwelve(List<String>names){
    ...
    public static boolean checkInitialIsNotToBeX(List<String>names){
