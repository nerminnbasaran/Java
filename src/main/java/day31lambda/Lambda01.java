...
public class Lambda01 {
    /*
        1)We learned "Structured Programming" so for, in "Structure Programming" structure is very important, we spend time on structure
        2)Lambda is "Functional Programming", in "Functional Programming" we will focus on just the functions(methods)
        3)"t-> code" is called "Lambda Expression" we may use "Lambda Expression"s it is not recommended.
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println(calculateMultiplicationOfSquareOfDistinctEvenElements(nums));//we use sout because this method is not print just calculate.
        System.out.println();
    ...
    public static void printEvenElements1(List<Integer> mylist){
       for(Integer w : mylist){//for Collections the best loop is for-each loop
           if(w%2==0){
    ...
    //3)Create a method to print the square of add list elements on the console
    ...
    public static void printCubeOfUniqueOddElements(List<Integer> mylist){
        ...
        mylist.stream().filter(t->t%2!=0).distinct().map(t->t*t*t).forEach(t-> System.out.println(t + " "));//distinct() method removes the repeated elements
                                                                                                            //Most of the time we can change the places of the methods
    }
    ...
    //6)Create a method to calculate "product" of the "square" of "distinct" "even" elements
    ...
    //8)Create a method to find any value which is less than 15 an even from the list
