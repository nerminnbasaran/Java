...
public interface AC {
    ...
    //When you create "bacteriaKiller()" default method", "Honda Concrete Child Class" will not complain, because
    //Overriding is mandatory for "abstract methods" but "bacteriaKiller() default method" is not abstract.
    //"default" in "bacteriaKiller() method" is not "access modifier", it is a new keyword to create "method with body" in an interface
    public default void bacteriaKiller(){
        System.out.println("AC is kill the bacteria %99,9...");
    }
    ...
    //Variables are "final" in an interface as default, that is why you create a variable ou have to initialize.
    ...
    //Note: An interface may have "public" or "default" access modifier, you can not use "protected" and "private" access modifiers same in "Classes"
}
