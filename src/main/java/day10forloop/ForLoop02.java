...
public class ForLoop02 {
    public static void main(String[] args) {
        ...
        String num=input.next().replaceAll("[^0-9]","");//to be able to use lots of string methods we use string class instead of the integer.String behaviour like integer
        ...
        for(int i=0;i<num.length();i++){
            ...
            sumOfUniques = sumOfUniques + Integer.valueOf(ch);//In integer class valueOf() method changes String to Integer
