...
public abstract class Animal { //classes can be just public or protected

    /*
       1) Sometimes we do not need method body,that is why we should not type it.
          If we do not type "body part" the method will be "method without body" it means it is "abstract method"
       ...
       5)If a functionality is not mandatory do not abstract make it concrete
       ...
       6)To make a method abstract
          ...
          Note: After creating an abstract method do not forget to use them in all "concrete" child classes.
                If you do not use the method in child classes, you will get error.
       ...
       13)We create abstract methods for the child classes to use, but if you make the access modifier "private" it means
