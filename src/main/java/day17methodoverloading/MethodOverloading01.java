...
public class MethodOverloading01 {
    ...
    public static void main(String[] args) {
        ...
        2) If you make method names and the parameters same in two different methods Java complains
        because if the names and the parameters are same Java will think the methods exactly same, and it will complain
        Typing the methods repeatedly cannot be accepted by Java
        3) Java checks the method and parameters (the variables inside the method parenthesis) to understand if the
        ...
        5)Access modifiers do not take any role in "method overloading", that is why methods in any access modifier
        can be overloaded

        6) To be static or non-static does not have any effect on method overloading, that is why static and non-static method
        can be overloaded
