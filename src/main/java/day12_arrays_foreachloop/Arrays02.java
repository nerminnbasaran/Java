...
public class Arrays02 {
    ...
    //Example 1: Create an integer Array, add six elements in it.Find the sum of all elements.
    ...
    int[] ages=new int[6];
        ...
        //Example 2: Create an integer array type code to find the sum of the minimum and maximum value
        // [12,45,9,56]==>9+56=65
        // sort()-->9, 12, 45, 56
