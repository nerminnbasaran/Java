...
public class E01 {
    ...
    /*
        ...
        1)"throw" is used inside the "method body", "throws" used in the method signature line
        ...
        "throws" can be used to throw both "Run Time Exceptions" or "CompileTime Exceptions"(Checked Exceptions)
       ...
       2)"Custom Exception Classes" can be i)Run Time Exception ii)Compile Time Exception
         To create Custom Run Time Exception, you must extend to "Run Time Exception Class"
