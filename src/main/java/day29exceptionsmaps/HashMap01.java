...
public class HashMap01 {
    ...
    public static void main(String[] args) {
        ...
        Set<String> keys = cp.keySet();// keySet() method returns all keys in a Set.Keys are unique because of that we use keySet()
        ...
        //Second replace() method update the value if the value is like given.
        ...
        Integer r1 = cp.getOrDefault("USA", 0);// getOrDefault() will check the key if it is existing it will find the value, if it isn't it gives us default value
