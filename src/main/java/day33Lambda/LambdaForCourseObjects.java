...
public class LambdaForCourseObjects {
    ...
    public static void main(String[] args) {
        ...
        List<Course> courses = new ArrayList<>();//every class can be a data type. Here Course is data type
        ...
        System.out.println(checkIfAnyCourseNameContainsAnyWord(courses, "Turkish"));//true
        printCourseWhoseAverageIsTheHighest(courses);
        System.out.println(skipFirstTwoReturnOthersAfterSorting(courses));
        printThirdCourseAfterSortingReversed(courses);
    }

    //1)Create e method to check if all average scores are greater than 91
    public static boolean checkAverageScoresToBeGreaterThanAnyNumber(List<Course> courses, double avg){
    ...
    public static void printCourseWhoseAverageIsTheHighest(List<Course> courses){
