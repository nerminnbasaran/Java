...
public class LinkedList01 {
    ...
    /*
        ...
        3)LinkedList does not use indexes, LinkedList works with "nodes"
          ...
          Pointer points next element
          Last node is called as "Tail" and LinkedList has head points the first node
        4)When you remove any element Java changes just pointers,
          does not touch the other elements. This is not too many tasks
          that is why we prefer to use "LinkedList" is removing operations.
        5)When you add any  element Java changes just pointers,
          does not touch the other elements. This is not too many tasks
          that is why we prefer to use "LinkedList" is adding operations.
        ...
        7)LinkedList does not use indexes, it means "nodes" do not have addresses.
          When you do not have address, it will be difficult to find the node.
        ...
        8)If you create a functionality to add and remove museum visitors in an app, use "LinkedList"
          If you create a functionality to add zipcodes and find zipcodes for specific areas, use "ArrayList"
