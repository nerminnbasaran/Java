...
public class E02 {
    public static void main(String[] args) {
        ...
        System.out.println(getElement(a, 5));//ArrayIndexOutOfBoundException -> Index 5 out of bounds for length 4
        ...
        System.out.println(getCharFromString(s, 12));//StringIndexOutOfBoundsException => String index out of bound range:12
   ...
   //Example 2: Create e method to get a character from a String
