...
public enum UsStates {
    ...
    /*
        ...
        For ex: For "Car Sale" application you need "Car Makes" that is why you have to store "Car Makes" in your application
                That kind of constant data is stored in "ENUMs".

        Note  : In ENUMS between the data we use comma not semicolon
     */
   ...
   private final String stateName;//everytime if we have data we are creating a container.we made it private because we use it in enum.
   private final String abbreviation;//making sth final means you will never able to change it.
   private final String capital;
    ...
    public String getStateName() {
        return stateName;
    }//to read data we should use "get()" method.
